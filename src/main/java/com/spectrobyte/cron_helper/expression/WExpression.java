...
public class WExpression extends BaseExpression {

    private final static Character character = 'W';

    public WExpression(List<IToken> tokens, Consumer<List<ResultToken>> callback) {
